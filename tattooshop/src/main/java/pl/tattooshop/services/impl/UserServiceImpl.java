...
import pl.tattooshop.repositories.RoleRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        pl.tattooshop.models.User user = userRepository.findByUsername(username);
        if (user == null) {
    ...
    private UserDetails createUserDetails(pl.tattooshop.models.User user) {
    ...
    @Override
    public void save(pl.tattooshop.models.User user) {
